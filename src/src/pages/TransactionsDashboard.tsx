...
import { AssignOwner } from '../components/transaction/AssignOwner';
...
export function TransactionsDashboard({ onViewTransaction, onViewProfile, onViewDemoForm, onViewSettings, onViewNews }: TransactionsDashboardProps) {
